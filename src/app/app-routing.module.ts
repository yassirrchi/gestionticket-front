...
,{path:"admin/login",component:LoginAdminComponent},{path:"admin/clients",component:ClientsComponent},{path:"admin/admins",component:AdminsComponent},{path:"admin/techniciens",component:TechniciensComponent}];
